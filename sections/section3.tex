...
\begin{proof}
    \begin{enumerate}[label=\alph*)]
        ...
        \TODO[Ist f überhaupt irreduzibel? Nope... Was bringt es uns etwas bzgl $M$ zu zeigen, wenn eig zz ist, dass $K_n|K$ galois ist...]
        \item $ $
        \begin{itemize}
            ...
            \TODO[Ist $L|K$ denn auch überhaupt galoisch?]
            \item[$\Rightarrow$]
            ...
            \TODO[Ist $L(\xi)|K(\xi)$ denn auch galoisch]
        \end{itemize}
    \end{enumerate}
\end{proof}
...
\begin{proof} $ $
    \begin{itemize}
        ...
        Nach \ref{theo:3.24} genügt es zu zeigen, dass $M(\xi)|K(\xi)$.\TODO[Jaa, und beweisen wir das noch? Oder nehmen wir das an?]
        Bemerke $M(\xi)|K(\xi)$ galois'sch \TODO[Nehmen wir das an? Zeigen wir das?]
        ...
        Sei $n$ eine Vielfaches von $m_1,\dots,m_r$ und $\xi$ eine primitive $n$-te EW und $M=K_r(\xi)$ galois'sch\TODO[$M|K$ oder $M|K(\xi)$ galois'sch].
